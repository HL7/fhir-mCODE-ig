...
When using this value set, the most specific term should be selected. The technique used in real life can be more specific than the code used to describe it. For example, *image-guided intensity-modulated radiation therapy* should be reported as IMRT because that category most closely aligns with the actual technique.
