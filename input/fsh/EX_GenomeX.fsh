...
* component[representative-transcript-ref-seq].valueCodeableConcept = NCBI#NM_004656 "NM_004656.4"
* component[representative-coding-hgvs].valueCodeableConcept = HGVS#NM_004656.4:c.1768C>T "NM_004656.4:c.1768C>T"
* component[representative-protein-hgvs].valueCodeableConcept = HGVS#NP_004647.1:p.(Gln590Ter) "NP_004647.1:p.(Gln590Ter)"  // Mutalizer normalized HGVS string for HGVS#p.Q590* "p.Q590*".
...
* component[representative-transcript-ref-seq].valueCodeableConcept = NCBI#NM_004656 "NM_004656"
* component[representative-coding-hgvs].valueCodeableConcept = HGVS#NM_001307940.2:c.430C>T "NM_001307940.2:c.430C>T"
* component[representative-protein-hgvs].valueCodeableConcept = HGVS#NP_001294869.1:p.(Pro144Ser) "NP_001294869.1:p.(Pro144Ser)"  // VariantValidator normalized HGVS string for p.P144S*".
* component[genomic-source-class].valueCodeableConcept = LNC#LA6684-0 "Somatic"
...
* component[genomic-source-class].valueCodeableConcept = LNC#LA6684-0 "Somatic"
// * component[molecular-consequence].valueCodeableConcept = SO#SO:0001583 "missense_variant"
* component[representative-transcript-ref-seq].valueCodeableConcept = NCBI#NM_004656 "NM_005035"
* component[representative-coding-hgvs].valueCodeableConcept = HGVS#NM_005035.4:c.598G>A "NM_005035.4:c.598G>A"
* component[representative-protein-hgvs].valueCodeableConcept = HGVS#NP_005026.3:p.(Gly200Arg) "NP_005026.3:p.(Gly200Arg)"  // VariantValidator normalized HGVS string for p.G200R
* component[genomic-source-class].valueCodeableConcept = LNC#LA6684-0 "Somatic"
...
* component[therapeutic-implication].valueCodeableConcept = LNC#LA9661-5 "Presumed responsive"
* performer = Reference(us-core-practitioner-owen-oncologist)
