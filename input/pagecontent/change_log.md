...
{:.new-content #TreatmentChanges}
  ...
  * Radiation therapy is expanded to include element requirements from the American Society for Radiation Oncology (ASTRO), resulting in additional profiles: [RadiotherapySummary] and [TeleradiotherapyPrescriptionDelivery]
