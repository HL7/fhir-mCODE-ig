...
* ^experimental = false
* ^caseSensitive = true
//* #USCRS-34947 "Surveillance Epidemiology and End Results Program Extent of Disease, 2018 edition (tumor staging)" // requested June 2023 // term given only in US edition, inserted NCI code in VS instead
//* #USCRS-34949 "Enneking surgical staging system (tumor staging)" // requested June 2023 // term rejected, inserted NCI code in VS instead
