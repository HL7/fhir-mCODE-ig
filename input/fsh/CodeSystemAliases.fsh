...
Alias:   UnitsOfTime = http://hl7.org/fhir/ValueSet/units-of-time
Alias:   TimingAbbreviation = http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation
Alias:   MedRequestStatus = http://hl7.org/fhir/ValueSet/medicationrequest-status
Alias:   MedRequestIntent = http://hl7.org/fhir/ValueSet/medicationrequest-intent