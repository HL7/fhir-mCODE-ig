...
* insert BundleSlice(medicationRecommendation, 0, *, Medication Recommendation, Task proposing medication recommendations based on genetic results., http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/medication-recommendation)
