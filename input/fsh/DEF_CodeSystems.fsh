...
* #INSTIT "Interstitial"  "Placement of radioactive source into tissue."
...
* #SURF "Surface" "Use of radioactive source to deliver dose to the surface of a target, e.g., skin or eye when eye plaque is used." 
* #VASC "Intravascular" "Placement of a radioactive source into a blood vessel or blood vascular system or vascular injection of radiopharmaceutical."
