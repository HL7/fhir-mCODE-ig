...
ValueSet:   ECRSecondaryCancerDisorderVS
Id: mcode-ECR-secondary-cancer-disorder-vs
Title: "ECR Secondary Cancer Disorder Value Set"
...
Description:   "ECR Pre-cancerous Condition"
* include codes from valueset ECRMiscCarcinomaInSituVS    
* include codes from valueset ECRCarcinomaInSituVS
* include codes from valueset ECRMelanomaInSituVS
* include codes from valueset ECRCytoEvidenceMalignancyVS
* include codes from valueset ECRBenignNeoplasmVS

ValueSet:  ECRMiscCarcinomaInSituVS
Id: mcode-misc-carcinoma-in-situ-vs
Title: "ECR Misc Carcinoma InSitu"
Description:   "ECR Misc Carcinoma InSitu"
...
ValueSet:  ECRMelanomaInSituVS
Id: mcode-melanoma-in-situ-vs
Title: "ECR Melanoma InSitu"
Description:    "ECR Melanoma InSitu"
...
ValueSet:  ECRCytoEvidenceMalignancyVS
Id: mcode-cyto-evidence-maligancy-vs
Title: "ECR Cyto Evidence Malignancy"
Description:    "ECR Cyto Evidence Malignancy"
...
ValueSet:  ECRCarcinomaInSituVS
Id: mcode-carcinoma-insitu-vs
Title: "ECR Carcinoma In-Situ"
...
ValueSet:  ECRBenignNeoplasmVS
Id: mcode-benign-neoplasm-vs
Title: "ECR Benign Neoplasm"
Description:    "Benign Neoplasms" 
...
ValueSet:  ECRPrimaryOrUncertainBehaviorCancerDisorderVS
Id: mcode-ecr-primary-or-uncertain-behavior-cancer-disorder-vs
...
* include codes from valueset ECRPrimaryCancerDisorderVS
* include codes from valueset ECRHeaderCancerDisorderVS

ValueSet:  ECRHeaderCancerDisorderVS
Id: mcode-ECR-header-cancer-disorder-vs
Title: "ECR Header  Cancer Disorder Value Set"
Description:    "ECRHeader." 
...
* ICD10CM#C43.3 "Malignant melanoma of other and unspecified part of face"
...
* ICD10CM#C4A "MERKEL CELL CARCINOMA"
* ICD10CM#C4A.1 "Merkel cell carcinoma of eyelid, including canthus"
...
* ICD10CM#C4A.2 "Merkel cell carcinoma of ear and external auricular canal"
* ICD10CM#C4A.3 "Merkel cell carcinoma of unspecified parts of face"
* ICD10CM#C4A.5 "Merkel cell carcinoma of trunk"
* ICD10CM#C4A.6 "Merkel cell carcinoma of upper limb, including shoulder"
* ICD10CM#C4A.7 "Merkel cell carcinoma of skin of lower limb, including hip"
* ICD10CM#C50 "MALIGNANT NEOPLASM OF BREAST"
* ICD10CM#C50.0 "Malignant neoplasm of nipple and areola"
* ICD10CM#C50.01 "Malignant neoplasm of nipple and areola of breast, female"
* ICD10CM#C50.02 "Malignant neoplasm of nipple and areola of breast, male"
...
* ICD10CM#C50.91 "Malignant neoplasm of breast of unspecified site of breast, female"
* ICD10CM#C50.92 "Malignant neoplasm of breast of unspecified site of breast, male"
...
* ICD10CM#C62.0 "Malignant neoplasm of undescended left testis"
...
* ICD10CM#C75 "MALIGNANT NEOPLASM OF OTHER ENDOCRINE AND RELATED STRUCTURES"
...
* ICD10CM#C7A.0 "Malignant neuroendocrine tumors"
...
* ICD10CM#C7A.09 "Malignant carcinoid tumors of others site"
...
* ICD10CM#C81.1 "Nodular sclerosis classical Hodgkin lymphoma"
* ICD10CM#C81.2 "Mixed cellularity classical Hodgkin lymphoma"
* ICD10CM#C81.3 "Lymphocyte depleted classical Hodgkin lymphoma"
* ICD10CM#C81.4 "Lymphocyte-rich classical Hodgkin lymphoma"
* ICD10CM#C81.7 "Other classical Hodgkin lymphoma"
...
* ICD10CM#C84.1 "Sezary's disease"
...
* ICD10CM#C85.1 "B-cell lymphoma, unspecified"
...
* ICD10CM#C91.5 "Adult T-cell lymphoma/leukemia (HTLV-1 associated) Prolymphocytic leukemia of T-cell type"
* ICD10CM#C91.6 "Mature B-cell leukemia Burkitt type"
...
ValueSet:  ECRPrimaryCancerDisorderVS
