// TODO How is this represented in GRIG STU3?  // MLT: Profile deprecated in GRIG STU3. It's now under Genomic Study Analysis.
...
* component[representative-protein-hgvs] and component[representative-protein-hgvs].code and component[representative-protein-hgvs].value[x] MS
