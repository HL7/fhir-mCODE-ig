...
* entry[cancerPatient].resource.meta.profile[0] = Canonical(CancerPatient)
...
* entry[primaryCancerCondition].resource.meta.profile[0] = Canonical(PrimaryCancerCondition)
* entry[2].resource = cancer-related-medication-request-cyclophosphamide-jenny-m
