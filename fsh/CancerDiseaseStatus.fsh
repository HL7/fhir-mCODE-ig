...
Conformance statement: To be mCODE conformant, all Observations associated with an mCODE patient (as defined herein) and using LOINC code 88040-1 and SHALL conform to this profile.
