...
* extension[doseDeliveredToVolume][0].extension[effectiveDoseDelivered].valueQuantity = 6000 'cGy'
...
* extension[doseDeliveredToVolume][1].extension[effectiveDoseDelivered].valueQuantity = 5000 'cGy'
