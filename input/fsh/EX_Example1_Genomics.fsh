...
/* mCODECancerGeneticVariantExample2 is an example of the
...
* subject = Reference(mCODEPatientExample1)
* effectiveDateTime = "2019-04-01"
* specimen = Reference(Specimen/mCODEGeneticSpecimenExample1)
* issued = "2019-04-01T11:45:33+11:00"
* result[CancerGeneticVariant] = Reference(Observation/mCODECancerGeneticVariantExample1)
* result[GenomicRegionStudied] = Reference(mCODEGenomicRegionStudiedExample1)
...
* collection.collector = Reference(mCODEPractitionerExample1)
