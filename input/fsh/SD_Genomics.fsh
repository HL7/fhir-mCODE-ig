...
* component[copyNumber] ^definition = "The genetic trait involving the number of copies of a particular gene present in the genome of an individual. (source: NCI)"
