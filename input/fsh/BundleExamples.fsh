...
scenario1-specimen-tumor

// Comorbid conditions - waiting on decision on how these will be profiled
scenario1-us-core-condition-anxiety
scenario1-mcode-comorbid-condition-depression
scenario1-mcode-comorbid-condition-hypertension
...
* entry[4].resource = scenario1-family-member-history-sister
