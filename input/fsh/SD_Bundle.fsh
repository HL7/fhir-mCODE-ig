...
* Procedure resources representing any [CancerRelatedSurgicalProcedure](StructureDefinition-mcode-cancer-related-surgical-procedure.html) or [CancerRelatedTeleradiotherapyProcedure](StructureDefinition-mcode-cancer-related-teleradiotherapy-procedure.html) or [CancerRelatedBrachytherapyProcedure](StructureDefinition-mcode-cancer-related-brachytherapy-procedure.html)
* Observation resources representing the TNM staging information ([see Disease Characterization profiles](artifacts.html#profiles-disease-characterization))
...
* entry contains
    ...
    cancerRelatedBrachytherapyProcedure 0..* MS and
    cancerRelatedTeleradiotherapyProcedure 0..* MS and
...
* entry[cancerRelatedTeleradiotherapyProcedure] ^short = "Cancer-Related Teleradiotherapy Procedure(s)"
* entry[cancerRelatedBrachytherapyProcedure] ^short = "Cancer-Related Brachytherapy Procedure(s)"
...
* entry[cancerRelatedTeleradiotherapyProcedure] ^definition = "Procedure resource(s) representing cancer-related external beam radiology procedures."
* entry[cancerRelatedBrachytherapyProcedure] ^definition = "Procedure resource(s) representing cancer-related brachytherapy (internal) radiology procedures."
...
* entry[cancerRelatedTeleradiotherapyProcedure].resource only CancerRelatedTeleradiotherapyProcedure
* entry[cancerRelatedBrachytherapyProcedure].resource only CancerRelatedBrachytherapyProcedure
