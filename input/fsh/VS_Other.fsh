...
Description: "A code system containing codes that signify a code outside the specified value set has been used, using an 'Other, specify: _________' approach."
