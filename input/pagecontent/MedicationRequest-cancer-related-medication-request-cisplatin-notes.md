...
* extension[=].valueCodeableConcept = http://snomed.info/sct#182992009 "Treatment completed (situation)"
* status = #active
* intent = #order
...
* dosageInstruction.route = http://snomed.info/sct#47625008 "Intravenous use"
