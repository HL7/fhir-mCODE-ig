...
| [`Genomics Report`](DiagnosticReport-genomics-report-jenny-m.html)| [GenomicsReport] | [USCoreLaboratoryResultObservation]|
| [`Genomic Specimen: Left Breast`](Specimen-genomic-specimen-left-breast-jenny-m.html) | [GenomicSpecimen] | [R4Specimen]|
| [`Genomic Variant Results: Pathogenic Variant in PALB2`](Observation-cancer-genomic-variant-jenny-m.html) | [GenomicVariant] |[USCoreLaboratoryResultObservation] |
...
| [`Oncotype DX Breast Recurrence Score Assay: 47/High`](Observation-tumor-marker-test-oncotype-dx-jenny-m.html)| [TumorMarkerTest] |[USCoreLaboratoryResultObservation]|
