...
6. The Data Sender SHALL be capable of populating every data element it implements. See the [Obligation to Implement](#obligation-to-implement) section to determine which elements MUST/SHOULD/MAY be supported for a given profile.
