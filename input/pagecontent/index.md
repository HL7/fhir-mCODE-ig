...
* [RadiotherapyPrescriptionDelivery] - to summarize an ongoing or completed course of radiotherapy, which may relate to multiple instances of brachytherapy or teleradiotherapy delivery records.
* [BrachytherapyDeliveryRecord] - documentation of internal radiation therapy using a particular modality and technique.
* [TeleradiotherapyDeliveryRecord] - documentation of external beam radiation therapy from photons, neutrons, protons, and other sources using a particular modality and technique.
