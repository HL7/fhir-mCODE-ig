...
* #LDR-PERM "Low Dose Rate Brachytherapy - Permanent Placement" "Radiation treatment that irradiates a anatomic volume with permanently placed radiation sources delivering low dose rates (typically less than or equal to 2 Gy/hour)."
* #LDR-TEMP "Low Dose Rate Brachytherapy - Temporary Placement" "Radiation treatment that irradiates a anatomic volume with temporarily placed radiation sources delivering low dose rates (typically less than or equal to 2 Gy/hour)."
