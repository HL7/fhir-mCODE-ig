...
* insert MapConceptQualifier2(#Ear_External_R, "External Ear Right", #117590005, "Ear structure (body structure\)", #7771000, "left(qualifier value\)", #261074009, " external(qualifier value\)")
...
* insert MapConceptQualifier2(#Ear_Internal_L, "Internal Ear Left", #117590005, "Ear structure (body structure\)", #7771000, "left(qualifier value\)", #260521003, " internal(qualifier value\)")
* insert MapConceptQualifier2(#Ear_Internal_R, "Internal Ear Right", #117590005, "Ear structure (body structure\)", #24028007, "right(qualifier value\)", #260521003, " internal(qualifier value\)")
...
* insert MapConceptQualifier2(#Ear_Middle_L, "Middle Ear Left", #117590005, "Ear structure (body structure\)", #7771000, "left(qualifier value\)", #260528009, " middle(qualifier value\)")
* insert MapConceptQualifier2(#Ear_Middle_R, "Middle Ear Right", #117590005, "Ear structure (body structure\)", #24028007, "right(qualifier value\)", #260528009, " middle(qualifier value\)")
...
* insert MapConceptQualifier2(#LN_Ax_Central_L, "Axillary lymphatic chain - Central Left", #16051009, " Structure of apical axillary lymph node (body structure\)", #7771000, "left(qualifier value\)", #26216008, " central(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_Central_R, "Axillary lymphatic chain - Central Right", #16051009, " Structure of apical axillary lymph node (body structure\)", #24028007, "right(qualifier value\)", #26216008, " central(qualifier value\)")
...
* insert MapConceptQualifier2(#LN_Ax_L1_L, "Level 1 Axillary Lymph Node Left", #68171009, "Axillary lymph node structure (body structure\)", #7771000, "left(qualifier value\)", #277733009, " level 1(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_L1_R, "Level 1 Axillary Lymph Node Right", #68171009, "Axillary lymph node structure (body structure\)", #24028007, "right(qualifier value\)", #277733009, " level 1(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_L2_L, "Level 2 Axillary Lymph Node Left", #68171009, "Axillary lymph node structure (body structure\)", #7771000, "left(qualifier value\)", #277734003, " level 2(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_L2_R, "Level 2 Axillary Lymph Node Right", #68171009, "Axillary lymph node structure (body structure\)", #24028007, "right(qualifier value\)", #277734003, " level 2(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_L3_L, "Level 3 Axillary Lymph Node Left", #68171009, "Axillary lymph node structure (body structure\)", #7771000, "left(qualifier value\)", #277735002, " level 3(qualifier value\)")
* insert MapConceptQualifier2(#LN_Ax_L3_R, "Level 3 Axillary Lymph Node Right", #68171009, "Axillary lymph node structure (body structure\)", #24028007, "right(qualifier value\)", #277735002, " level 3(qualifier value\)")
