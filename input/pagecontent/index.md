...
<ul>
    ...
    <li><b>Patient Bundle</b> - the <a href="mcode-patient-bundle.html">mCODE patient bundle</a> contains all information about the patient defined in mCODE in a single resource that can be sent over the wire.</li>
</ul>
