...
lookup = {
  ...
  "level ib" => "#1162617002",
  "level ii" => "#258401000",
  "level iia" => "#1284814003",            # missing from qualifier value set and SNOMEDCT - USCRS-34777
  "level iib" => "#1284815002",            # missing from qualifier value set and SNOMEDCT - USCRS-34775
  "level iii" => "#258402007",
